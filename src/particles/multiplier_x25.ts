...
export const MULTIPLIER_X25: particle.EffectProperties = {
  version: {
    major: 8,
    minor: 0,
    patch: 0,
  ...
  emitterProperties: [
    {
      ...
      images: ['multiplier_x25_d2895c78e3bb5a6199ad8c31'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
      ...
      affectors: {
        ...
        colorOverLifetime: {
          ...
          colorEaseType: 0,
          colorValues: [
            0, 1, 1, 1, 1, 0.7662337662337663, 1, 1, 1, 1, 1, 1, 1, 1, 0,
          ],
          darkEaseType: 0,
    ...
    },
    {
      ...
      images: ['multiplier_x25_01e31b1cd86dff489a12884c'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
    ...
    },
    {
      ...
      images: ['multiplier_x25_94ee17e17b994383e3f5706d'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
      ...
      affectors: {
        ...
        scaleOverLifetime: {
          ...
          values: [
            [
              0, 0, 0.20391061452513967, 0.6995708154506437, 0.8016759776536313,
    ...
    },
    {
      ...
      images: ['multiplier_x25_b3d82429760b4774eda60fbb'],
      anchor: {
        type: 'vector2',
        value: [0, -1],
      },
    ...
    },
    {
      ...
      images: ['multiplier_x25_c560e184c4f99f7e65fd7532'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
