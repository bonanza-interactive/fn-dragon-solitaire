...
export const MULTIPLIER_X10: particle.EffectProperties = {
  version: {
    major: 8,
    minor: 0,
    patch: 0,
  ...
  emitterProperties: [
    {
      ...
      images: ['multiplier_x10_d2895c78e3bb5a6199ad8c31'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
      ...
      affectors: {
        ...
        colorOverLifetime: {
          ...
          colorEaseType: 0,
          colorValues: [
            0, 1, 1, 1, 1, 0.7610389610389611, 1, 1, 1, 1, 1, 1, 1, 1, 0,
          ],
          darkEaseType: 0,
    ...
    },
    {
      ...
      images: ['multiplier_x10_01e31b1cd86dff489a12884c'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
    ...
    },
    {
      ...
      images: ['multiplier_x10_ccd4a4b3c58bd9fddb4c911d'],
      anchor: {
        type: 'vector2',
        value: [0, 0],
      },
      ...
      affectors: {
        ...
        scaleOverLifetime: {
          ...
          values: [
            [
              0, 0, 0.20391061452513967, 0.6995708154506437, 0.7960893854748603,
    ...
    },
    {
      ...
      images: ['multiplier_x10_b3d82429760b4774eda60fbb'],
      anchor: {
        type: 'vector2',
        value: [0, -1],
      },
